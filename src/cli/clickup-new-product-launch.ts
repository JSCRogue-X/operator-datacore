...
const WILL    = 32554033; // will.murphy@hetrading.co.uk
const ANTHONY = 32547067; // anthony@spincare.co.uk
const LAURA   = 93868392; // laura@spincare.co.uk
const PAUL    = 87803456; // paul@spincare.co.uk

// Assignees by subtask name (lowercase). Multiple user IDs per task are supported.
const ASSIGNEES: Record<string, number[]> = {
  'duplicate product launch sheet':                          [WILL],
  'provide launch/retail/list pricing for amazon locales':   [ANTHONY],
  'provide features/benefits for the products':             [ANTHONY],
  'product demo':                                           [ANTHONY],
  'provide image brief notes':                              [ANTHONY],
  'complete marketing handover':                            [ANTHONY],
  'create maxamaze project':                                [LAURA],
  ...
  'request production samples':                             [PAUL],
  'maxamaze project complete':                              [LAURA],
  'basic mintsoft sku setup':                               [JON],
  'basic linnworks import':                                 [JON],
  'create mkl':                                             [WILL],
  'create listing data':                                    [WILL],
  'research/setup ppc campaigns':                           [WILL],
  'create sp campaigns':                                    [WILL],
  'add to branded search campaign':                         [WILL],
  'create negative keyword list':                           [WILL],
  'update/add negative master keyword list':                [WILL],
  'add pts as negative product targets':                    [WILL],
  'review listing':                                         [ANTHONY, LAURA],
  'listing amends':                                         [WILL],
  'approve listing':                                        [ANTHONY, LAURA],
  'complete ih launch template':                            [LAURA, WILL],
  'import & list products on ih channels':                  [WILL],
  'create flat file template':                              [WILL],
  'sub task - add b2b pricing':                             [WILL],
  'sub task - set max order quantity to 20':                [WILL],
  'sub task upload to amazon / close listing':              [WILL],
  'sostocked sku setup':                                    [PAUL],
  'create/save sds (fast track)':                           [JON],
  'review/approve fast track sds completed.':               [JON],
  'complete pcm entry':                                     [JON],
  'upload sds':                                             [WILL],
  'send test shipment':                                     [JON],
  'inventory - ship inventory to amazon uk':                [PAUL],
  'inventory - ship inventory to amazon eu':                [PAUL],
  'add images to listing':                                  [WILL],
  'launch email campaign':                                  [LAURA],
  'ebay promoted listing setup':                            [WILL],
  'ebay add multi-buy discounts':                           [WILL],
  'add shopify multi-buy discounts':                        [WILL],
  'announce launch on social media':                        [WILL],
  'amazon launch':                                          [WILL],
  'add to marketing kpi tracker':                           [LAURA],
  'enrol in vine (if using)':                               [WILL],
  'create coupon':                                          [WILL],
  'add to rank radar':                                      [WILL],
  'add cost price into sellerboard.io':                     [ANTHONY],
  'enter cogs into sellerboard':                            [WILL],
  'add asin to storefront':                                 [WILL],
  'sub task - add asin to home page':                       [WILL],
  'sub task - add asin to category page':                   [WILL],
  'weekly review price':                                    [WILL],
  'add campaigns to scale insights automation':             [WILL],
  'negative keyword check':                                 [WILL],
  'check review request automation (captaina)':             [WILL],
  'analyse reviews for listing improvements (60 days)':     [WILL],
  'analyse reviews for listing improvements (90 days)':     [WILL],
  're-order eligibility (60 days)':                         [ANTHONY, PAUL, LAURA],
  're-order eligibility (90 days)':                         [ANTHONY, PAUL, LAURA],
};
